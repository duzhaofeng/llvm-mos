...
private:
  ...
  void printMCS51Direct(const MCInst *MI, unsigned OpNo, raw_ostream &O);
  void printMCS51Bit(const MCInst *MI, unsigned OpNo, raw_ostream &O);
  void printMCS51Imm(const MCInst *MI, unsigned OpNo, raw_ostream &O);
